#ifndef LOCALIZATION_POINT_TYPES_H
#define LOCALIZATION_POINT_TYPES_H
...
POINT_CLOUD_REGISTER_POINT_STRUCT(localization::FullPointType,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (float, range, range)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(ouster_ros::Point,
                                  ...
                                  (float, z, z)
                                  (float, intensity, intensity)
                                  //使用std::uint32_t，防止和pcl::uint32_t冲突
                                  (std::uint32_t, t, t)
...
#endif  // LOCALIZATION_POINT_TYPES_H
